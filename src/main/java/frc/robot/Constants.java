...
//Constants for pathplanning
  ...
  public static final class DriveConstants {
    ...
    //Determines the radius from the center of the robot to the furthest swerve module
    public static final double DriveRadius = Units.inchesToMeters(18.73833);

    // Chassis configuration
    public static final double kTrackWidth = Units.inchesToMeters(30-3.5);
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = Units.inchesToMeters(30-3.5);
  ...
  public static final class ModuleConstants {
    ...
    // Invert the turning encoder, since the ou    mm,tput shaft rotates in the opposite direction of
